...
"resource": {
  ...
  "macros":[{
      "function":"__jsm",
      "vtp_javascript":["template","(function(){try{var b=ga.getAll(),c;var a=0;for(c=b.length;a\u003Cc;a+=1)if(\"UA-3367751-1\"==b[a].get(\"trackingId\"))return b[a].get(\"clientId\")}catch(d){}return\"false\"})();"]
    },{
      "function":"__jsm",
      ...
      "vtp_dimension":["list",["map","index","5","dimension",["macro",0]],["map","index","6","dimension",["macro",1]]],
      "vtp_enableEcommerce":false,
      "vtp_trackingId":"UA-3367751-1",
      ...
      "vtp_decorateFormsAutoLink":false,
      "vtp_enableLinkId":false,
      "vtp_dimension":["list",["map","index","6","dimension",["macro",1]]],
      "vtp_enableEcommerce":false,
      "vtp_trackingId":"UA-3367751-1",
      "vtp_enableRecaptchaOption":false,
      "vtp_enableUaRlsa":false,
  ...
  "tags":[{
      ...
      "vtp_overrideGaSettings":false,
      "vtp_eventCategory":"Resource Download",
      "vtp_trackType":"TRACK_EVENT",
      ...
      "vtp_fieldsToSet":["list",["map","fieldName","page","value",["template",["macro",8],["macro",8]]]],
      ...
      "vtp_uniqueTriggerId":"6664715_11",
      "tag_id":8
    },{
      "function":"__lcl",
      "vtp_waitForTags":false,
      "vtp_checkValidation":false,
      "vtp_waitForTagsTimeout":"2000",
      "vtp_uniqueTriggerId":"6664715_13",
      "tag_id":9
    },{
      "function":"__lcl",
      ...
      "vtp_checkValidation":false,
      "vtp_waitForTagsTimeout":"2000",
      "vtp_uniqueTriggerId":"6664715_15",
      "tag_id":10
    },{
      "function":"__sdl",
      ...
      "vtp_uniqueTriggerId":"6664715_17",
...
return null},Vc=!1;if(F.querySelectorAll)try{var Wc=F.querySelectorAll(":root");Wc&&1==Wc.length&&Wc[0]==F.documentElement&&(Vc=!0)}catch(a){}var Sc=Vc;var jd={},kd=null,ld=Math.random();jd.s="GTM-N9N76KC";jd.Ob="5r0";jd.Ld="";var md={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},od="www.googletagmanager.com/gtm.js";
var pd=od,qd=null,rd=null,sd=null,td="//www.googletagmanager.com/a?id="+jd.s+"&cv=9",ud={},vd={},wd=function(){var a=kd.sequence||0;kd.sequence=a+1;return a};
...
W.a.sdl=["google"],function(){function a(){return!!(Object.keys(l("horiz.pix")).length||Object.keys(l("horiz.pct")).length||Object.keys(l("vert.pix")).length||Object.keys(l("vert.pct")).length)}function b(y){for(var A=[],B=y.split(","),z=0;z<B.length;z++){var D=Number(B[z]);if(isNaN(D))return[];p.test(B[z])||A.push(D)}return A}function c(){var y=0,A=0;return function(){var B=Ak(),z=B.height;y=Math.max(w.scrollLeft+B.width,y);A=Math.max(w.scrollTop+z,A);return{qg:y,rg:A}}}function d(){q=R("self");
u=q.document;w=u.scrollingElement||u.body&&u.body.parentNode;x=c()}function e(y,A,B,z){var D=l(A),H={},M;for(M in D){H.Ga=M;if(D.hasOwnProperty(H.Ga)){var N=Number(H.Ga);y<N||(Pk({event:"gtm.scrollDepth","gtm.scrollThreshold":N,"gtm.scrollUnits":B.toLowerCase(),"gtm.scrollDirection":z,"gtm.triggers":D[H.Ga].join(",")}),gk("sdl",A,function(Z){return function(Y){delete Y[Z.Ga];return Y}}(H),{}))}H={Ga:H.Ga}}}function f(){var y=x(),A=y.qg,B=y.rg,z=A/w.scrollWidth*100,D=B/w.scrollHeight*100;e(A,"horiz.pix",
r.Mb,t.Id);e(z,"horiz.pct",r.Lb,t.Id);e(B,"vert.pix",r.Mb,t.ae);e(D,"vert.pct",r.Lb,t.ae);fk("sdl","pending",!1)}function h(){var y=250,A=!1;u.scrollingElement&&u.documentElement&&q.addEventListener&&(y=50,A=!0);var B=0,z=!1,D=function(){z?B=Lk(D,y):(B=0,f(),Tk("sdl")&&!a()&&(oc(q,"scroll",H),oc(q,"resize",H),fk("sdl","init",!1)));z=!1},H=function(){A&&x();B?z=!0:(B=Lk(D,y),fk("sdl","pending",!0))};return H}function k(y,A,B){if(A){var z=b(String(y));gk("sdl",B,function(D){for(var H=0;H<z.length;H++){var M=
String(z[H]);D.hasOwnProperty(M)||(D[M]=[]);D[M].push(A)}return D},{})}}function l(y){return hk("sdl",y,{})}function m(y){G(y.vtp_gtmOnSuccess);var A=y.vtp_uniqueTriggerId,B=y.vtp_horizontalThresholdsPixels,z=y.vtp_horizontalThresholdsPercent,D=y.vtp_verticalThresholdUnits,H=y.vtp_verticalThresholdsPixels,M=y.vtp_verticalThresholdsPercent;switch(y.vtp_horizontalThresholdUnits){case r.Mb:k(B,A,"horiz.pix");break;case r.Lb:k(z,A,"horiz.pct")}switch(D){case r.Mb:k(H,A,"vert.pix");break;case r.Lb:k(M,
A,"vert.pct")}Tk("sdl")?hk("sdl","pending")||(v||(d(),v=!0),G(function(){return f()})):(d(),v=!0,w&&(Uk("sdl"),fk("sdl","pending",!0),G(function(){f();if(a()){var N=h();nc(q,"scroll",N);nc(q,"resize",N)}else fk("sdl","init",!1)})))}var p=/^\s*$/,r={Lb:"PERCENT",Mb:"PIXELS"},t={ae:"vertical",Id:"horizontal"},q,u,w,v=!1,x;(function(y){W.__sdl=y;W.__sdl.b="sdl";W.__sdl.g=!0;W.__sdl.priorityOverride=0})(function(y){y.vtp_triggerStartOption?m(y):xj(function(){m(y)})})}();
...
W.a.ua=["google"],function(){var a,b={},c=function(e){Rc(function(){d(e)},[C.H,C.o])},d=function(e){var f={},h={},k={},l={},m={};if(e.vtp_gaSettings){var p=e.vtp_gaSettings;n(Dl(p.vtp_fieldsToSet,"fieldName","value"),h);n(Dl(p.vtp_contentGroup,"index","group"),k);n(Dl(p.vtp_dimension,"index","dimension"),l);n(Dl(p.vtp_metric,"index","metric"),m);e.vtp_gaSettings=null;p.vtp_fieldsToSet=void 0;p.vtp_contentGroup=void 0;p.vtp_dimension=void 0;p.vtp_metric=void 0;var r=n(p);e=n(e,r)}n(Dl(e.vtp_fieldsToSet,
"fieldName","value"),h);n(Dl(e.vtp_contentGroup,"index","group"),k);n(Dl(e.vtp_dimension,"index","dimension"),l);n(Dl(e.vtp_metric,"index","metric"),m);Oc(C.H)||(h.storage="none"),Oc(C.o)||(h.allowAdFeatures=!1,h.storeGac=!1);var t=$g(e.vtp_functionName);if(na(t)){var q="",u="";e.vtp_setTrackerName&&"string"==typeof e.vtp_trackerName?""!==e.vtp_trackerName&&(u=e.vtp_trackerName,q=u+"."):(u="gtm"+wd(),
...
allowAdFeatures:!0,allowAdPersonalizationSignals:!0},x=function(O){var P=[].slice.call(arguments,0);P[0]=q+P[0];t.apply(window,P)},y=function(O,P){return void 0===P?P:O(P)},A=function(O,P){if(P)for(var Ba in P)P.hasOwnProperty(Ba)&&x("set",O+Ba,P[Ba])},B=function(){},
...
W.a.aev=["google"],function(){function a(q,u){var w=de(q,"gtm");if(w)return w[u]}function b(q,u,w,v){v||(v="element");var x=q+"."+u,y;if(p.hasOwnProperty(x))y=p[x];else{var A=a(q,v);if(A&&(y=w(A),p[x]=y,r.push(x),35<r.length)){var B=r.shift();delete p[B]}}return y}function c(q,u,w){var v=a(q,t[u]);return void 0!==v?v:w}function d(q,u){if(!q)return!1;var w=e(Mk());pa(u)||(u=String(u||"").replace(/\s+/g,"").split(","));for(var v=[w],x=0;x<u.length;x++)if(u[x]instanceof RegExp){if(u[x].test(q))return!1}else{var y=
u[x];if(0!=y.length){if(0<=e(q).indexOf(y))return!1;v.push(e(y))}}return!Cl(q,v)}function e(q){m.test(q)||(q="http://"+q);return me(oe(q),"HOST",!0)}function f(q,u,w){switch(q){case "SUBMIT_TEXT":return b(u,"FORM."+q,h,"formSubmitElement")||w;case "LENGTH":var v=b(u,"FORM."+q,k);return void 0===v?w:v;case "INTERACTED_FIELD_ID":return l(u,"id",w);case "INTERACTED_FIELD_NAME":return l(u,"name",w);case "INTERACTED_FIELD_TYPE":return l(u,"type",w);case "INTERACTED_FIELD_POSITION":var x=a(u,"interactedFormFieldPosition");
return void 0===x?w:x;case "INTERACT_SEQUENCE_NUMBER":var y=a(u,"interactSequenceNumber");return void 0===y?w:y;default:return w}}function h(q){switch(q.tagName.toLowerCase()){case "input":return pc(q,"value");case "button":return qc(q);default:return null}}function k(q){if("form"===q.tagName.toLowerCase()&&q.elements){for(var u=0,w=0;w<q.elements.length;w++)kk(q.elements[w])&&u++;return u}}function l(q,u,w){var v=a(q,"interactedFormField");return v&&pc(v,u)||w}var m=/^https?:\/\//i,p={},r=[],t={ATTRIBUTE:"elementAttribute",
CLASSES:"elementClasses",ELEMENT:"element",ID:"elementId",HISTORY_CHANGE_SOURCE:"historyChangeSource",HISTORY_NEW_STATE:"newHistoryState",HISTORY_NEW_URL_FRAGMENT:"newUrlFragment",HISTORY_OLD_STATE:"oldHistoryState",HISTORY_OLD_URL_FRAGMENT:"oldUrlFragment",TARGET:"elementTarget"};(function(q){W.__aev=q;W.__aev.b="aev";W.__aev.g=!0;W.__aev.priorityOverride=0})(function(q){var u=q.vtp_gtmEventId,w=q.vtp_defaultValue,v=q.vtp_varType;switch(v){case "TAG_NAME":var x=a(u,"element");return x&&x.tagName||
w;case "TEXT":return b(u,v,qc)||w;case "URL":var y;a:{var A=String(a(u,"elementUrl")||w||""),B=oe(A),z=String(q.vtp_component||"URL");switch(z){case "URL":y=A;break a;case "IS_OUTBOUND":y=d(A,q.vtp_affiliatedDomains);break a;default:y=me(B,z,q.vtp_stripWww,q.vtp_defaultPages,q.vtp_queryKey)}}return y;case "ATTRIBUTE":var D;if(void 0===q.vtp_attribute)D=c(u,v,w);else{var H=q.vtp_attribute,M=a(u,"element");D=M&&pc(M,H)||w||""}return D;case "MD":var N=q.vtp_mdValue,Z=b(u,"MD",wk);return N&&Z?zk(Z,N)||
...
W.a.lcl=[],function(){function a(){var c=R("document"),d=0,e=function(f){var h=f.target;if(h&&3!==f.which&&!(f.Kg||f.timeStamp&&f.timeStamp===d)){d=f.timeStamp;h=sc(h,["a","area"],100);if(!h)return f.returnValue;var k=f.defaultPrevented||!1===f.returnValue,l=hk("lcl",k?"nv.mwt":"mwt",0),m;m=k?hk("lcl","nv.ids",[]):hk("lcl","ids",[]);if(m.length){var p=dk(h,"gtm.linkClick",m);if(b(f,h,c)&&!k&&l&&h.href){var r=String(Wk(h,"rel")||""),t=!!sa(r.split(" "),function(w){return"noreferrer"===w.toLowerCase()});
t&&I("GTM",36);var q=R((Wk(h,"target")||"_self").substring(1)),u=!0;if(Pk(p,Tj(function(){var w;if(w=u&&q){var v;a:if(t){var x;try{x=new MouseEvent(f.type)}catch(y){if(!c.createEvent){v=!1;break a}x=c.createEvent("MouseEvents");x.initEvent(f.type,!0,!0)}x.Kg=!0;f.target.dispatchEvent(x);v=!0}else v=!1;w=!v}w&&(q.location.href=Wk(h,"href"))}),l))u=!1;else return f.preventDefault&&f.preventDefault(),f.returnValue=!1}else Pk(p,function(){},l||2E3);return!0}}};nc(c,"click",e,!1);nc(c,"auxclick",e,!1)}
